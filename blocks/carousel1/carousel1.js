...
export default async function decorate(block) {
  ...
  block.setAttribute('aria-roledescription', placeholders.carousel1 || 'carousel1');
  ...
  if (!isSingleSlide) {
    ...
    slideIndicatorsNav.setAttribute('aria-label', placeholders.carousel1SlideControls || 'carousel1 Slide Controls');
